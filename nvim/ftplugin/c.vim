...
nnoremap <silent> <Leader>t :!./generate_cscope.sh<CR>:!cscope -bcqR<CR>:cscope reset<CR>
nnoremap <silent> <Leader>T :!./generate_cscope.sh<CR>:!cscope -bcqR<CR>:cscope kill -1<CR>:cscope add .<CR>
